...
\begin{description}
    ...
    \item[\autoref{ch:desarrollo}] Describe el proceso de desarrollo del sistema, incluyendo la metodología de trabajo empleada, la selección y configuración de arquitecturas, el diseño del flujo de procesamiento de entrenamiento, y las diferentes iteraciones experimentales realizadas.
    
    \item[\autoref{ch:resultados}] Presenta los resultados experimentales obtenidos en los diferentes datasets utilizados, incluyendo la evaluación comparativa frente a métodos tradicionales. Se discuten los resultados en relación a los objetivos planteados y al estado del arte.
    ...
    \item[\deschyperlink{ch:anexos}{Anexos}] Remiten al repositorio del proyecto, donde se encuentra disponible el material técnico complementario (código fuente, configuraciones experimentales, scripts y resultados detallados) para la reproducibilidad de los experimentos.
...
Todo el material generado durante la ejecución de este proyecto está disponible en el repositorio \thegitrepo{}. El repositorio contiene el código fuente completo de los módulos y clases de entrenamiento y evaluación de modelos, los scripts de curación y preprocesamiento del conjunto de datos, el código de la aplicación interactiva desarrollada con Streamlit para análisis comparativo de resultados y visualización de predicciones, así como los ficheros de configuración necesarios para reproducir íntegramente los experimentos descritos en esta memoria. Se ha priorizado la organización modular del código y la documentación de los procedimientos para facilitar la reproducibilidad y posibilitar extensiones futuras del trabajo.
