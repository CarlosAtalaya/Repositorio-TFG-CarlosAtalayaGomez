...
Todo el material generado durante la ejecución de este proyecto está disponible en el repositorio \thegitrepo{}. El repositorio contiene el código fuente completo de los módulos y clases de entrenamiento y evaluación de modelos, los scripts de curación y preprocesamiento del dataset, el código de la aplicación Streamlit para análisis comparativo de resultados y visualización de predicciones, así como los ficheros de configuración necesarios para reproducir íntegramente los experimentos descritos en esta memoria. Se ha priorizado la organización modular del código y la documentación de los procedimientos para facilitar la reproducibilidad y posibilitar extensiones futuras del trabajo.
