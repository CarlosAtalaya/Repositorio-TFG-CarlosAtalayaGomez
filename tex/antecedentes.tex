...
\midrule
Bias inductivo & Local (asume vecindad espacial) & Sin asunción de localidad \\
Campo receptivo & Limitado por apilamiento de convoluciones & Global desde la primera capa \\
Mecanismo de atención & Implícito (operaciones locales) & Explícito (self-attention entre parches) \\
\bottomrule
\end{tabular}
\end{table}

Con estos fundamentos arquitectónicos establecidos, se revisan a continuación las técnicas de aprendizaje auto-supervisado que permiten aprovechar los ViT en escenarios con datos limitados.
