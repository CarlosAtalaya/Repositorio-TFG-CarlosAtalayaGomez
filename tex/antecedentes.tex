...
\caption{Arquitectura Vision Transformer (ViT)~\cite{dosovitskiy2021vit}.}
...
\caption{Arquitectura DEIMv2~\cite{huang2025deimv2}: backbone DINOv3, \acrshort{STA} para multi-escala y decodificador DETR.}
