...
A efectos de seguimiento, se adopta la siguiente \textbf{nomenclatura}: (i) \textit{Preparación del dataset} designa el trabajo previo de curación y normalización de datos, articulado en \textbf{cinco etapas} del pipeline (Etapas 1--5, con subetapas 4.1--4.4 donde corresponde); (ii) las \textbf{Fases experimentales 1--4} corresponden a la experimentación propiamente dicha, con \textbf{Experimentos} en las Fases 1 y 3, e \textbf{Iteraciones} en la Fase 2. Esta distinción entre preparación y experimentación permite al lector localizar con precisión cada apartado del desarrollo.
...
Etapa 4.1 & Recuración: sin \texttt{hazelnut}, sin duplicados & 1{,}393 & 15 \\
...
El desarrollo experimental se ha estructurado en cuatro fases principales, cada una con objetivos específicos y metodología adaptada. Nótese que la \textbf{preparación del dataset} (Sección~\ref{sec:preparacion_dataset}) constituye un bloque previo e independiente; las fases que se enumeran a continuación corresponden exclusivamente a la experimentación con modelos:
...
Los resultados de la Fase 1 establecen líneas base claras y actúan como \textbf{motor de búsqueda} que impulsa la exploración de arquitecturas alternativas:
